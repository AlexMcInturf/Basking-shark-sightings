...
bs = fread("UK_bs_records.csv", header = TRUE, stringsAsFactors = FALSE) #fread = faster way of reading table (ask Evan why this is better?)

head(bs)
# Converting chr to date
bs$`Start date` = as.Date(bs$`Start date`,format = "%m/%d/%Y")
# again ask Evan what the ' ' does. I assume that it just gives the column a name, rather than one word 
